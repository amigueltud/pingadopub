...
public class ISP extends CryptoPerson implements CSP {
    ...
    String web_server="http://18.222.58.157";
...
//        String url = controller.getURL("http://localhost", "/", contract_file); // logan6
        String url = controller.getURL(web_server, "/", contract_file); // Amazon
